...
import com.comdomino.controller.UnidadeFacade;
...
public class UnidadeController implements Serializable {
    ...
    @EJB
    private com.comdomino.controller.UnidadeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("UnidadeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("UnidadeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("UnidadeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Unidade getUnidade(java.lang.Long id) {
