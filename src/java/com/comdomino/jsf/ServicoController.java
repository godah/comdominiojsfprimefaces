...
import com.comdomino.controller.ServicoFacade;
...
public class ServicoController implements Serializable {
    ...
    @EJB
    private com.comdomino.controller.ServicoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ServicoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ServicoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ServicoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Servico getServico(java.lang.Long id) {
